...
--
-- Hôte : localhost:8889
-- Généré le : lun. 08 déc. 2025 à 10:23
...
CREATE TABLE `pages_legales` (
  `id` int NOT NULL,
  `section` enum('cgu','mentions') COLLATE utf8mb4_general_ci NOT NULL,
...
(31, 15, 'Paris', 'Marseille', '2025-12-06', '20:13:00', 30.00, 4, 'Personne chaleureuse', '2025-12-05 17:10:27'),
(32, 15, 'Paris', 'Marseille', '2025-12-06', '20:11:00', 20.00, 3, '', '2025-12-05 17:11:35');
...
(15, 'jean petit', 'jean@gmail.com', '$2y$10$Q4DtRU1bfXfdHjEPsVdjuuTm6qcoD8auln8s.5Y9FIYXPgNL/Tx5G', '2025-11-20 13:56:53', 'avatar_15_692a14d1cb90b.jpg', NULL, '1995-05-05', '0651457254', 'Ile-de-France', 1, 0, 0, 'Peugeot 208', 'Noir', '/Caramba/public/uploads/identite/id_691f1015d97fa.PNG', '/Caramba/public/uploads/permis/permis_15_693302c10fa5d.jpeg', '2025-12-05 17:05:21', '', 0, 1, 'conducteur', NULL, NULL, 'Conducteur fiable et ponctuel, j’aime partager la route dans la bonne humeur. Habitué au covoiturage, trajet agréable garanti, j\'aime parler aussi.', 1, NULL, NULL),
(16, 'lucie dupont', 'lucie@gmail.com', '$2y$10$SdZCCfRbVlYMwFynJwksneBfdeJVQXl0L.oMp6.AowlWlPh5yfX1e', '2025-11-20 13:57:33', 'avatar_16_1763852399.jpg', 'Femme', '1997-12-14', '0678134157', 'Ile-de-France', 1, 0, 0, NULL, NULL, 'uploads/identite/id_691f103d01fc7.png', '', NULL, 'lucie5', 0, 0, 'passager', NULL, NULL, 'Passager calme et ponctuel, habitué au covoiturage. J’aime les trajets simples et respectueux, toujours partant pour partager la route en bonne humeur.', 0, NULL, NULL),
